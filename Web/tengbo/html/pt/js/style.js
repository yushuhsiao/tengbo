...
$(document).ready(function(){
	...
	/*存款取款*/
	$(".money_tabs li").click(function(){
		var num = $(".money_tabs li").index(this);
		$(this).addClass("cur").siblings().removeClass("cur");
		$(".tab_h2").eq(num).fadeIn().siblings().hide();
		})
...
$(function(){
			 ...
			 /*天一国际*/
			 $(".type").hover(function(){
                 $(this).find(".bg_r").animate({top:"0px"},200);
             },function(){
                 $(this).find(".bg_r").animate({top:"110px"},200);
             })
			 /* 天一国际*/
        })
