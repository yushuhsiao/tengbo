...
namespace com.yeepay.icc
{
	...
	public abstract class Buy
	{
      ...
      //public static string GetMerId() { return merchantId; }
        ...
        public static string CreateBuyHmac(string merchantId, string p2_Order, string p3_Amt, string p4_Cur, string p5_Pid, string p6_Pcat, string p7_Pdesc,
            string p8_Url, string p9_SAF, string pa_MP, string pd_FrpId, string pr_NeedResponse, string nodeAuthorizationURL, string keyValue)
		{
			string sbOld = "";
            //1
            sbOld += "Buy";
        ...
        public static BuyQueryOrdDetailResult QueryOrdDetail(string merchantId, string p2_Order, string keyValue)
		{
			string sbOld = "";
		...
		/// <returns></returns>
        public static BuyRefundOrdResult RefundOrd(string merchantId, string pb_TrxId, string p3_Amt, string p4_Cur, string p5_Desc, string keyValue)
		{
			string sbOld = "";
