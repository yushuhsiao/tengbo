...
namespace webAPI
{
    public class MemberGameRowCommand_SPORTS : MemberGameRowCommand<MemberGameRowCommand_SPORTS, MemberGameRow_WFT>
    {
        [JsonProperty]
        ...
        public MemberGameRowCommand_SPORTS(GameID gameID, string tableName, bool hasAPI) : base(gameID, tableName, hasAPI) { }
        public MemberGameRowCommand_SPORTS() : base(GameID.WFT_SPORTS, "Member_008", true) { }
        ...
        internal override bool OnGameDeposit(SqlCmd sqlcmd, GameTranRowCommand command, GameTranRow tran)
        {
            ...
            if (row == null)
                row = (MemberGameRow_WFT)(new MemberGameRowCommand_SPORTS() { MemberID = tran.MemberID }).OnUpdate(sqlcmd, "");
