...
//        internal override MemberGameRow_SUNBET OnUpdate2(SqlCmd _sqlcmd, string json_s, params object[] args)
//        {
//            SqlCmd sqlcmd;
...
//                MemberGameRow_SUNBET row = this.GetRow2(sqlcmd, this.MemberID.Value);
//                if (row == null)
//                {
...
//                    return sqlcmd.ExecuteEx<MemberGameRow_SUNBET>(sql);
//                }
//                else
//                {
//                    sqltool s = new sqltool();
...
//                    return sqlcmd.ExecuteEx<MemberGameRow_SUNBET>(sqlstr);
//                }
//            }
//        }
