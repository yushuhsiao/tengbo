    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $table = $('#table01').jqGrid_init({
                ...
                SelectCommand: function (postData) { return { AgentGroupSelect: postData } },
                UpdateCommand: function (postData) { return { AgentGroupRowCommand: postData } },
                InsertCommand: function (postData) { postData.op_Insert = true; return { AgentGroupRowCommand: postData } },
                colModel: [
