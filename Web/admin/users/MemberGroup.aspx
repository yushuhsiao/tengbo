    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $table = $('#table01').jqGrid_init({
                ...
                SelectCommand: function (postData) { return { MemberGroupSelect: postData } },
                UpdateCommand: function (postData) { return { MemberGroupRowCommand: postData } },
                InsertCommand: function (postData) { postData.op_Insert = true; return { MemberGroupRowCommand: postData } },
                colModel: [
