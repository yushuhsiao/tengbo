        ...
        loadItems: function(m, o) {
            ...
            a.map(m, function(w) {
                ...
                if (typeof w === "string") {
                    ...
                    if (w.label == null && w.value == null && w.html == null && w.group == null && w.groupHtml == null) {
                        j.label = w.toString();
                        j.value = w.toString()
                    } else {
                        j.label = w.label;
                ...
                if (typeof w != "string") {
                    if (w.label === undefined) {
                        if (t.displayMember != "") {
                            if (w[t.displayMember] != undefined) {
                                j.label = w[t.displayMember]
                            } else {
                                j.label = ""
                            }
                        }
                    ...
                    if (w.value === undefined) {
                        if (t.valueMember != "") {
                            j.value = w[t.valueMember]
                        }
                    }
                }
                j.hasThreeStates = w.hasThreeStates != undefined ? w.hasThreeStates : true;
                j.originalItem = w;
                if (o) {
                    j.originalItem = w.originalItem
                }
                j.title = y;
                if (y && j.value === undefined && j.label === undefined) {
                    j.value = j.label = y
                }
                j.html = w.html || "";
                if (w.html && w.html != "") {
                ...
                j.group = x;
                j.checked = w.checked || false;
                j.groupHtml = w.groupHtml || "";
                j.disabled = w.disabled || false;
                j.visible = w.visible != undefined ? w.visible : true;
                j.index = b;
                e[b] = j;
                b++;
                return j
