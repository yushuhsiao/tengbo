            ...
            if (!G.apply) {
                G.apply = G[E] = function() {
                    ...
                    h.each(D[I.$id + E], function(N, O) {
                        ...
                        M.push({
                            widgetName: E,
                            element: P,
                            result: h.jqx.jqxWidgetProxy(E, P, L)
                        })
                    });
                    if (M.length == 1) {
                        return M[0].result
                ...
                G.refresh = function(P, O) {
                    ...
                    h.each(G, function(Q, S) {
                        if (Q === "created" || Q == "data" || Q == "refresh" || Q == E || Q == "apply") {
                            return true
                        }
            ...
            if (L.jqxWatchSettings != i) {
                if (J) {
                    ...
                    h.each(K, function(O, S) {
                        ...
                        if ((Q && Q.indexOf(O) >= 0) || O.match(/(mousedown|click|mouseenter|mouseleave|mouseup|keydown|keyup|focus|blur|keypress)/g)) {
                            return true
                        }
                        if (O === E) {
                            return true
            ...
            M.$watch(L.jqxSettings, function(S, R) {
                ...
                if (S != R) {
                    h.each(S, function(U, X) {
                        ...
                        if ((V && V.indexOf(U) >= 0) || U.match(/(mousedown|click|mouseenter|mouseleave|mouseup|keydown|keyup|focus|blur|keypress)/g)) {
                            return true
                        }
                        var W = function(Z) {
                            if (L.jqxWatchSettings != i) {
                                if (J) {
                                    if (!p[L.jqxSettings + "." + Z]) {
                                        var Z = U;
                                        var Y = J.$watch(L.jqxSettings + "." + Z, function(ad, ac) {
                                            if (ad != ac) {
                                                var aa = {};
                                                aa[Z] = ad;
                        ...
                        if (!(X instanceof Object) && (R == null || X !== R[U])) {
                            ...
                            if (U !== E && U !== "apply" && U !== "created" && (X instanceof Object) && (R == null || (A(X) !== A(R[U])) || (A(X) == "" && A(R[U]) == ""))) {
                                P[U] = X;
                                W(U);
                                O = true
                            }
                    ...
                    if (L.indexOf("jqx-toggle-button") >= 0) {
                        ...
                        if (L.indexOf("jqx-link-button") >= 0) {
                            ...
                            if (L.indexOf("jqx-data-table") >= 0) {
                                ...
                                if (L.indexOf("jqx-list-box") >= 0 || L.indexOf("jqx-drop-down-list") >= 0 || L.indexOf("jqx-combo-box") >= 0) {
                                    if (h(H).find("option").length > 0) {
                                        h(H).replaceWith('<select id="jqx-ngwidget">' + F + "</select>")
                                    } else {
                                    ...
                                    if (L.indexOf("jqx-list-menu") >= 0) {
                                        h(H).replaceWith('<ul id="jqx-ngwidget" data-role="listmenu">' + F + "</ul>")
                                    } else {
            ...
            var N = v(function() {
                            ...
                            aa.$render = function() {
                                ...
                                if (E === "jqxRadioButton") {
                                    if (Q.$eval(h(K).attr("value")) == aa.$viewValue) {
                                        ...
                                        if (Q.$eval(h(K).attr("value")) == "true" && aa.$viewValue == true) {
                                            h(K).val(true)
                                        } else {
                                            h(K).val(false)
                                        }
                                        ...
                                        if (E === "jqxRadioButton") {
                                            ...
                                            if (E === "jqxCheckBox") {
                                                if (h(K).attr("ng-true-value") != i && ae.checked) {
                                                    ...
                                                    if (h(K).attr("ng-false-value") != i && !ae.checked) {
                                                ...
                                                if (E === "jqxDropDownList" || E === "jqxComboBox" || E === "jqxListBox" || E === "jqxInput") {
                                                    var ah = h(K).val();
                                                    if (P.jqxNgModel != i) {
                ...
                var V = function() {
                    if (P.jqxCreate != null || P.jqxCreate != null) {
                        if (P.jqxCreate === true || (P.jqxCreate !== null && h.type(P.jqxCreate) == "object")) {
                            U()
                        } else {
            ...
            return {
                ...
                template: function(P, O) {
                    ...
                    h.each(O, function(R, S) {
                        if (R !== E && R != "jqxNgModel" && R.indexOf("jqxOn") == -1 && R != "jqxData" && R != "jqxWatchSettings" && R != "jqxCreated" && R != "jqxSource" && R != "jqxCreate" && R != "jqxSettings" && R.indexOf("jqx") >= 0) {
                            if (!e[E]) {
                                e[E] = new Array()
                            }
                            e[E].push({
