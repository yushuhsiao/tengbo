...
(function(i) {
    i.jqx.observableArray = function(e, J) {
        ...
        I.toJSON = function(W, N) {
            ...
            function L(Y) {
                return '"' + Y.replace(S, function(Z) {
                    var aa = V[Z];
                    return typeof aa === "string" ? aa : "\\u" + ("0000" + Z.charCodeAt(0).toString(16)).slice(-4)
                }) + '"'
            }
            ...
            function O(Z) {
                var Y;
                if (isFinite(Z.valueOf())) {
                    Y = Z.getUTCFullYear() + "-" + M(Z.getUTCMonth() + 1) + "-" + M(Z.getUTCDate()) + "T" + M(Z.getUTCHours()) + ":" + M(Z.getUTCMinutes()) + ":" + M(Z.getUTCSeconds()) + 'Z"'
                } else {
                    Y = "null"
                }
                return Y
            ...
            function X(ab) {
                var Z = [],
                    aa, Y;
                for (aa in ab) {
                    if (Object.prototype.hasOwnProperty.call(ab, aa)) {
                        if (aa != "" && W && W.indexOf(aa) === -1) {
                            continue
                        }
                        Y = Q(aa, ab);
                        if (Y) {
            ...
            function Q(Z, Y) {
                var ab = Y[Z],
                    aa = typeof ab;
                if (ab && typeof ab === "object" && typeof ab.toJSON === "function") {
                    ab = ab.toJSON(Z);
                    aa = typeof ab
                }
                if (/(number|float|int|integer|string|boolean)/.test(aa) || (!ab && aa === "object")) {
                    return U(ab, aa)
                } else {
                    return R(ab)
                }
            }
            if (!W && window.JSON && typeof window.JSON.stringify === "function") {
        ...
        I.defineIndexProperty = function(N) {
            if (!(N in I)) {
                var L = function(U, R, T, Q) {
                    var S = U[R];
                    var P = S;
                    var O = function() {
                        return P
                    ...
                    var V = function(aa) {
                        ...
                        if (P !== S) {
                            ...
                            if (typeof H === "function") {
                                var X = K.indexOf(Q);
                                var Y = "";
                                var W = function(ac, ab) {
                                    Object.getOwnPropertyNames(ac).forEach(function(ad) {
                                        var ae = i.type(ac[ad]);
                                        if (ae == "array" || ae == "object") {
                                            W(ac[ad], ab + "." + ad)
                                        } else {
                                            if (R === ad) {
                                                Y = ab + "." + ad
                    ...
                    if (U[R] && R != "length") {
                        if (Object.defineProperty) {
                            ...
                            if (Object.prototype.__defineGetter__ && Object.prototype.__defineSetter__) {
                                Object.prototype.__defineGetter__.call(U, R, O);
                                Object.prototype.__defineSetter__.call(U, R, V)
                            }
                        }
                    }
                };
                var M = function(R, Q, O) {
                    var P = i.type(R);
                    if (/(number|float|int|integer|string|boolean)/.test(P)) {
                        return
                    }
                    if (R === undefined) {
                        return
                ...
                Object.defineProperty(I, N, {
                    ...
                    set: function(P) {
                        var O = K[N];
                        if (I.toJSON(null, O) != I.toJSON(null, P)) {
                            K[N] = P;
                            if (typeof H === "function") {
                                H({
                                    object: I,
        ...
        I.slice = function(P, M, O) {
            var L = K.slice(P, M);
            var N = new i.jqx.observableArray(L, O);
            return N
        };
        I.splice = function(P, Q, L) {
            var O = [],
                T, S;
            P = !~P ? K.length - P : P;
            Q = (Q == null ? K.length - P : Q) || 0;
            while (Q--) {
                T = K.splice(P, 1)[0];
                O.push(T);
                delete I[K.length];
            ...
            for (var M = 2, R = arguments.length; M < R; M++) {
                K.splice(P, 0, arguments[M]);
                defineIndexProperty(K.length - 1);
                if (typeof H === "function") {
                    H({
                        object: I,
            ...
            var N = new i.jqx.observableArray(O, L);
            return N
        };
            ...
            set: function(L) {
                ...
                if (M % 1 === 0 && M >= 0) {
                    if (M < K.length) {
                        ...
                        if (M > K.length) {
                            I.push.apply(I, new Array(M - K.length))
                        }
                    }
                } else {
        ...
        i.jqx.observableArray.prototype.fromArray = function(N, M) {
            var L = new i.jqx.observableArray(N, M);
            return L
        };
        i.jqx.observableArray.prototype.clone = function() {
            var L = new i.jqx.observableArray(K, J);
            L.observing = I.observing;
            L.changes = I.changes;
            L.notifier = I.notifier;
            return L
        };
        I.remove = function(M) {
            if (M < 0 || M >= I.length) {
                throw new Error("Invalid index : " + M)
            }
        ...
        I.concat = function(M, O) {
            var L = K.concat(M);
            var N = new i.jqx.observableArray(L, O);
            return N
        };
        Object.getOwnPropertyNames(Array.prototype).forEach(function(L) {
            if (!(L in I)) {
                var M = function() {
                    var P = I.observing;
                    I.observing = false;
                    var O = K[L];
                    var N = O.apply(K, arguments);
                    I.observing = P;
                    return N
                };
        ...
        I.set = function(M, O) {
            if (i.type(M) == "string" && M.split(".").length > 1) {
                var L = M.split(".");
                var P = I;
