...
(function(d) {
    var b = {
        ...
        _addRange: function(m, g) {
            ...
            var q = n._getAngleByValue(m.startValue),
                j = n._getAngleByValue(m.endValue),
                o = n._originalRadius,
                f = o - n._getRangeDistance(m.startDistance, m.startWidth),
                s = o - n._getRangeDistance(m.endDistance, m.endWidth),
                l = m.startWidth,
                e = m.endWidth,
                k = n._outerBorderOffset(),
                i = {
                    x: o + k + f * Math.sin(q),
                    y: o + k + f * Math.cos(q)
                },
                ...
                t = n._getProjectionPoint(q, o + k, f, l),
                p = n._getProjectionPoint(j, o + k, s, e),
                h = "default",
                u, m;
        ...
        _addLabel: function(s) {
            ...
            var g = s.angle,
                ...
                p = f - s.distance,
                h = j.labels.offset,
                q = j.labels.formatValue,
                i = j._outerBorderOffset(),
                n = f + i + p * Math.sin(g) + h[0],
                l = f + i + p * Math.cos(g) + h[1],
                o = s.value,
                k = s.style || "",
                e, m;
            ...
            e = j.renderer.measureText(o, 0, {
                "class": k
            });
            m = j.renderer.text(o, Math.round(n) - e.width / 2, Math.round(l), e.width, e.height, 0, {
        ...
        _addCaption: function() {
            var i = this.that;
            var k = i.caption.value,
                j = i.toThemeProperty("jqx-gauge-caption"),
                g = i.caption.offset,
                m = i.renderer.measureText(k, 0, {
                    "class": j
                }),
                h = i._getPosition(this.caption.position, m, g),
                e = i.caption.style,
                f = i._outerBorderOffset(),
                l = i.renderer.text(k, h.left + f, h.top + f, m.width, m.height, 0, {
                    "class": j
                });
            this._caption = l
        },
    ...
    var c = {
            ...
            _getMaxLabelSize: function() {
                ...
                var g = this.renderer.measureText(h, 0, {
                        "class": this.toThemeProperty("jqx-gauge-label")
                    }),
                    f = this.renderer.measureText(e, 0, {
                        "class": this.toThemeProperty("jqx-gauge-label")
                    });
                if (f.width > g.width) {
                    return f
