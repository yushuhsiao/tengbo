...
(function(b) {
    ...
    b.extend(b.jqx._jqxGrid.prototype, {
        ...
        createInstance: function(h) {
            ...
            this.gridtable = null;
            this.isNestedGrid = this.host.parent() ? this.host.parent().css("z-index") == 9999 : false;
        ...
        deleterow: function(j, h) {
            if (j != undefined) {
                ...
                var e = function(n, m) {
                    if (n._loading) {
                        throw new Error("jqxGrid: " + n.loadingerrormessage);
                        return false
                    }
                    var o = false;
                    var p = n.vScrollInstance.value;
                    if (!b.isArray(m)) {
                        var o = n.dataview.deleterow(m)
                    } else {
                        b.each(m, function() {
                            o = n.dataview.deleterow(this, false)
                        });
                        n.dataview.refresh()
                    }
                    if (n._updating == undefined || n._updating == false) {
                        if (h == undefined || h == true) {
                            n._render(true, true, false, false);
                            if (n.vScrollBar.css("visibility") != "visible") {
                                n._arrange();
                                n._updatecolumnwidths();
                                n._updatecellwidths();
                                n._renderrows(n.virtualsizeinfo)
                            }
                        }
                    }
                    if (n.source && n.source._knockoutdatasource && !n._updateFromAdapter && n.autokoupdates) {
                        if (n.source._source._localdata) {
                            ...
                            n.source._source._localdata.pop(rowdata);
                            n.source.suspendKO = false
                        }
                    }
                    var l = n.source && n.source._source.localdata && n.source._source.localdata.name === "observableArray";
                    if (l) {
                        if (!n.source._source.localdata._updating) {
                            n.source._source.localdata._updating = true;
                            n.source._source.localdata.splice(g, 1);
                            n.source._source.localdata._updating = false
                        }
                    }
                    if (n.dataview.sortby) {
                        n.dataview.clearsortdata()
                    }
                    n.vScrollInstance.setPosition(p);
                    return o
                };
