    ...
    b.extend(b.jqx._jqxEditor.prototype, {
        ...
        createInstance: function(k) {
            ...
            if (o == true || o == "true") {
                ...
                g.selection = new a(g.editorDocument);
                var n = b("<div class='jqx-editor-toolbar-container' unselectable='on' aria-label='Formatting options' role='toolbar'><div class='jqx-editor-toolbar'></div>");
                ...
                var h = b("<div class='jqx-editor'><div class='jqx-editor-container'><div class='jqx-editor-toolbar-container' aria-label='Formatting options' role='toolbar'><div class='jqx-editor-toolbar'></div></div><div class='jqx-editor-content'><iframe  src='javascript:void(0)' allowtransparency='true' frameborder='0'></iframe></div></div></div>");
                g.widget = h;
                g.widget[0].className = g.widget[0].className + " " + g.element.className;
                try {
                    g.widget[0].style = g.element.style
                } catch (l) {}
                var j = b.trim(g.host.html()) + "&#8203;";
                ...
                if (g.host.is("textarea")) {
                    ...
                    b(g.element).addClass(g.toThemeProperty("jqx-widget"));
                    g.host = b(g.element);
                    g.host.data(f)
                }
                try {
                ...
                g.editor = b(g.editorDocument.body);
                g.editor.html(j).attr("spellcheck", false).attr("autocorrect", "off");
                b.jqx.utilities.resize(h, function() {
        ...
        _addHandlers: function() {
            ...
            e.addHandler(e.editor, "paste.editor" + e.element.id, function(k) {
                ...
                var g = b(e.editorDocument).find(".jqx-editor-paste-element");
                ...
                setTimeout(function() {
                    ...
                    e.marker.remove();
                    var s = b(e.editorDocument).find("#INSERTION_MARKER");
            ...
            e.addHandler(e.editor, "dblclick.editor" + e.element.id, function(g) {
                ...
                if (g.target.tagName.toLowerCase() == "img") {
                    var h = g.target;
                    if (b(".jqx-editor-image-window").length > 0) {
                        e.editImage = h;
        ...
        _updateLinkWindow: function() {
            var g = this;
            var i = b(".jqx-editor-link-window");
            i.jqxWindow({
                position: {
                    center: g.widget
                }
        ...
        _updateImageWindow: function() {
            ...
            var h = b(".jqx-editor-image-window");
            h.jqxWindow({
                position: {
                    center: g.widget
                }
        ...
        _createLinkAction: function(d, k, l) {
            ...
            if (b(".jqx-editor-link-window").length > 0) {
                if (k.editLink) {
                    k.selection.selectNode(e, true)
                }
                k._updateLinkWindow();
