    ...
    <%--<script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $table = $('#table1').jqGrid_init({
                useDefValues: true, pager: true, nav1 : '#nav1', nav2: '#nav2', postData: { IsDeposit: true, IsHist: false },
                ...
                colModel: [
                  ...
                  //{ name: 'Accept         ', label: '<%=lang["colAccept       "]%>', width: 060, editable: true, formatter: $.empty, edittype: 'checkboxs', editoptions: { multiple: false, value: { 1: '<%=lang["op_Accept"]%>' } } },
                    ...
                    { name: 'LogType        ', label: '<%=lang["colLogType      "]%>', width: 080, editable: true, editonce: true, edittype: 'select', editoptions: { <%=enumlist<LogType>("value", true, BU.LogType.Deposit, BU.LogType.Alipay)%> }, formatter: 'select', formatoptions: { <%=enumlist<LogType>("value")%> } },
