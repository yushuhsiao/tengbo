    ...
    <script type="text/javascript">
        ...
        $(document).ready(function (ind, rowid) {
            ...
            $table = $('#table1').jqGrid_init({
                ...
                SelectCommand: function (postData) { return { GameLog_PointsSelect: postData } },
                ...
                colModel: [
                    ...
                    { name: 'sn             ', label: '<%=lang["colSN           "]%>', width: 060, sorttype: 'text', fixed: true, hidden: true, key: true },
                  ...
                  //{ name: 'MemberID       ', label: '<%=lang["colMemberID     "]%>', width: 050, sorttype: 'int' },
                    ...
                    { name: 'AgentACNT      ', label: '<%=lang["colAgentACNT    "]%>', width: 080, search: true }, 
