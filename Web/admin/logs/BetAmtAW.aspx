    ...
    <script type="text/javascript">
        ...
        $(document).ready(function (ind, rowid) {
            ...
            $table = $('#table1').jqGrid_init({                
                pager: true, loadonce: false, sortname: 'ACTime1',                
                cmTemplate: { editable: false, editonce: false },
                SelectCommand: function (postData) { return { GameLog_BetAmtAW_Select: postData } },

                colModel: [
                    { name: 'ACTime1        ', label: '<%=lang["colACTime1      "]%>', width: 080, sorttype: 'date', formatter: 'datejs', formatoptions: { format: 'yyyy-MM-dd', formatNaN: 'N/A' } },
                    { name: 'ACTime2        ', label: '<%=lang["colACTime2      "]%>', width: 080, sorttype: 'date', formatter: 'datejs', formatoptions: { format: 'yyyy-MM-dd', formatNaN: 'N/A' } },
