...
<BODY style="OVERFLOW-X: auto; OVERFLOW-Y: auto" id=body onload=InitPage() MS_POSITIONING="GridLayout"><FORM id=am_QueryTodayTrans onsubmit=CheckValid() method=post name=am_QueryTodayTrans action=am_QueryTodayTrans.aspx>
<DIV><INPUT id=__EVENTTARGET type=hidden name=__EVENTTARGET> <INPUT id=__EVENTARGUMENT type=hidden name=__EVENTARGUMENT> <INPUT id=__LASTFOCUS type=hidden name=__LASTFOCUS> <INPUT id=__VIEWSTATE value= type=hidden name=__VIEWSTATE> </DIV>
...
<DIV><INPUT id=__EVENTVALIDATION value=/wEWCgKR0JXSBgLK5aCoBAKAwvDZDQKehae6BQLUmfTWAQLA+7iOCgL9mpmPAQKSm5bSAwLm9cyQAgKU69TQBcAlbhfL8k4TqaWjrStPYuh0K/f5 type=hidden name=__EVENTVALIDATION> </DIV>
...
<TBODY>
<TR>
<TD class=tdLeftH30>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;子账户：<SELECT style="WIDTH: 200px" id=ddlSubAccountList name=ddlSubAccountList> <OPTION selected value=125222485000002>活期结算户 人民币 00000</OPTION></SELECT> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;交易类型：<SELECT style="WIDTH: 100px" id=ddlTransTypeList name=ddlTransTypeList> <OPTION selected value=->[ 全部 ]</OPTION> <OPTION value=ICRR>客户转账</OPTION></SELECT> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT id=BtnOK class=btn value="查 询" type=submit name=BtnOK> </TD></TR></TBODY></TABLE></TD></TR>
<TR>
...
<TR>
<TD align=middle>2013-04-25</TD>
<TD align=right>&nbsp;</TD>
<TD align=right>1,600.11</TD>
<TD style="COLOR: #585858" align=right>3,309.39</TD>
<TD align=left>客户转账</TD>
<TD align=left>网银贷记接收收款 赖秋坛</TD></TR></TBODY></TABLE>
...
<TD class=tdLeftW30H20>&nbsp; 存入交易笔数： <SPAN id=InCount class=wcLabel>1</SPAN></TD>
<TD class=tdLeftH20></TD></TR>
<TR>
<TD class=tdLeftW30H20>&nbsp; 支出金额合计： <SPAN id=OutTotalMoney class=wcLabel>0.00</SPAN></TD>
<TD class=tdLeftW30H20>&nbsp; 存入金额合计： <SPAN id=InTotalMoney class=wcLabel>1,600.11</SPAN></TD>
