CREATE TABLE [dbo].[tranCash1] (
    ...
    [CreateTime]         DATETIME         CONSTRAINT [DF_tranBalance1_CreateTime] DEFAULT (getdate()) NOT NULL,
    [CreateUser]         INT              NOT NULL,
    [ModifyTime]         DATETIME         CONSTRAINT [DF_tranBalance1_ModifyTime] DEFAULT (getdate()) NOT NULL,
    ...
    CONSTRAINT [PK_tranCash1] PRIMARY KEY CLUSTERED ([ID] ASC)
);
