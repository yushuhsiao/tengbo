CREATE TABLE [dbo].[tranFirstDeposit2] (
    ...
    [CreateTime]         DATETIME         CONSTRAINT [DF_tranFirstDeposit2_CreateTime_1] DEFAULT (getdate()) NOT NULL,
    [CreateUser]         INT              NOT NULL,
    [ModifyTime]         DATETIME         CONSTRAINT [DF_tranFirstDeposit2_ModifyTime_1] DEFAULT (getdate()) NOT NULL,
    [ModifyUser]         INT              NOT NULL,
    [Memo1]              NVARCHAR (100)   NULL,
    [Memo2]              NVARCHAR (100)   NULL,
    CONSTRAINT [PK_tranFirstDeposit2] PRIMARY KEY CLUSTERED ([ID] ASC)
);
