CREATE TABLE [dbo].[MemberTran2] (
    ...
    [CreateTime]   DATETIME         CONSTRAINT [DF_MemberTran2_CreateTime] DEFAULT (getdate()) NOT NULL,
    [CreateUser]   INT              NOT NULL,
    [ModifyTime]   DATETIME         CONSTRAINT [DF_MemberTran2_ModifyTime] DEFAULT (getdate()) NOT NULL,
    ...
    CONSTRAINT [PK_MemberTran2] PRIMARY KEY CLUSTERED ([ID] ASC)
);
