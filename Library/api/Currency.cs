...
namespace BU
{
    class CurrencyCodeJsonConverter : JsonConverter
    {
    ...
    {
        USD = CurrencyCode_All.USD,
        HKD = CurrencyCode_All.HKD,
        PHP = CurrencyCode_All.PHP,
        CNY = CurrencyCode_All.CNY,
        TWD = CurrencyCode_All.TWD,
    }
    // 所有語系
    public enum CurrencyCode_All
    {
    ...
    //{
    //    // 將字串轉換成幣別定義
    //    public static CurrencyCode FromString(this CurrencyCode _default, string s)
    //    {
    //        return ((CurrencyCode?)_default).FromString(s) ?? _default;
    //    }
    //    public static CurrencyCode? FromString(this CurrencyCode? code, string s)
    //    {
    //        s = (s ?? "").Trim().ToUpper();
    //        if (Enum.IsDefined(typeof(CurrencyCode), s))
    //            return (CurrencyCode)Enum.Parse(typeof(CurrencyCode), s);
    //        return null;
    //    }
    //    //public static xxx
    //}
